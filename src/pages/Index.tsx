...
import { Wallet, TrendingUp, CreditCard, PieChart, IndianRupee, ShieldCheck, Zap, Brain } from "lucide-react";
      ...
      <div className="relative z-10 container mx-auto px-4 py-6 max-w-7xl">
        ...
        <header className="text-center mb-8 animate-fade-in">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-6 backdrop-blur-sm">
            ...
            <span className="text-sm font-medium text-primary">AI-Powered Finance Analysis</span>
            <span className="px-2 py-0.5 text-xs rounded-full bg-accent/20 text-accent font-semibold">BETA</span>
          </div>
        ...
        {/* Main chat interface */}
        <div 
          className="glass-card-elevated overflow-hidden animate-scale-in opacity-0" 
          style={{ 
        ...
        {/* Footer */}
        <footer className="mt-6 text-center animate-fade-in" style={{ animationDelay: "600ms" }}>
