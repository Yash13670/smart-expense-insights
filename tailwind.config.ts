  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "glow-pulse": {
          "0%, 100%": { boxShadow: "0 0 30px hsl(160 84% 45% / 0.2)" },
          "50%": { boxShadow: "0 0 60px hsl(160 84% 45% / 0.4)" },
        },
        "shimmer": {
      ...
      boxShadow: {
        glow: "0 0 60px hsl(160 84% 45% / 0.25)",
        "glow-accent": "0 0 40px hsl(280 80% 60% / 0.2)",
        card: "0 8px 32px hsl(230 25% 3% / 0.6)",
        elevated: "0 16px 48px hsl(230 25% 3% / 0.7)",
      },
    },
  },
